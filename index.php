...
<body>
                        ...
                        <div class="header-info header-info-right">
                            <ul>
                                <li>
                                    ...
                                    <strong class="text-brand"> + 25322</strong>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="index.html"><img src="assets/imgs/Capture.PNG" alt="logo" /></a>
                    </div>
                    <div class="header-right">
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a href="/admin/"><span class="lable ml-0">Registrasi Agen </span></a>
                                </div>
                                <div class="header-action-icon-2">
                                    <a href="./admin/"><span class="lable ml-0">Buka Toko</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mobile-header-content-area">
                    ...
                    <nav>
                        <ul class="mobile-menu font-heading">
                            <li class="menu-item-has-children">
                                ...
                                <ul class="dropdown">
                                    <li><a href="index.html">Telur Ayam</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="">Buka Toko</a>
                            ...
                            <li class="menu-item-has-children">
                                <a href="/admin/dashboard.php">Registrasi Agen</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                <div class="mobile-header-info-wrap">
                    <div class="single-mobile-header-info">
                        <a href="page-login.html"><i class="fi-rs-user"></i>Lihat Keranjang
                        </a>
                    </div>
                    <div class="single-mobile-header-info">
                        <a href="/admin/index.php"><i class="fi-rs-user"></i>Log In / Sign Up
                        </a>
                    </div>
                </div>
    ...
    <main class="main">
        ...
        <section class="bg-grey-1 section-padding mt-30 pb-80 mb-80">
            <div class="container">
                <h3 class="mb-30 text-center">Kategori Produk</h3>
                <div class="row">
                ...
                <!--row-->
                <h3 class="text-center mt-30 mb-30">Update Harga</h3>
                        ...
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="deals-content">
                                    <h2>
                                        <a href="shop-product-right.html">Telur Ayam Ras/Horn</a>
                                    </h2>
                                    ...
                                    <div>
                                        <span class="font-small text-muted">Oleh <a href="vendor-details-1.html">PT. Istana Baru</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>Rp.26.000 /Kg</span>
                                        </div>
                                        <div class="add-cart">
                                            <a class="add" href="shop-cart.html">Selengkapnya
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="deals-content">
                                    <h2>
                                        <a href="shop-product-right.html">Telur Ayam Arab</a>
                                    </h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                    ...
                                    <div>
                                        <span class="font-small text-muted">Oleh
                                            <a href="vendor-details-1.html">PT. Makmur Jaya</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>Rp.16.000 /Kg</span>
                                        </div>
                                        <div class="add-cart">
                                            <a class="add" href="shop-cart.html">Selengkapnya
                                            </a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="deals-content">
                                    <h2>
                                        <a href="shop-product-right.html">Telur Burung Puyuh</a>
                                    </h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                    ...
                                    <div>
                                        <span class="font-small text-muted">Oleh <a href="vendor-details-1.html">Progresso</a></span>
                                    </div>
                                    <div class="product-card-bottom">
                                        <div class="product-price">
                                            <span>Rp.26.000 /Kg</span>
                ...
                <div class="row">
                    ...
                    <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        ...
                        <ul class="footer-list mb-sm-5 mb-md-0">
                            ...
                            <li><a href="/admin/dashboard.php">Registrasi Agen</a></li>
    ...
    <!-- Template  JS -->
    <script src="assets/js/main17e6.js?v=5.2"></script>
    <script src="assets/js/shop17e6.js?v=5.2"></script>
</body>
