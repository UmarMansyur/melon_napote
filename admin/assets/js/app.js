window.onload = function () {
  let width = document.querySelector(".pace-running").offsetWidth;
...
function checkSideBar() {
  const body = document.querySelector(".sidebar-enable");
  const element = document.getElementById("profile");
  if (body) {
    document.getElementById('text-logo').classList.remove('d-none');
    element.classList.remove("d-none");
    return;
  } 
  document.getElementById('text-logo').classList.add('d-none');
  element.classList.add("d-none");
}
!(function (s) {
  "use strict";
