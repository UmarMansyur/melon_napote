                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="harga" class="form-label">Kategori</label>
                                        <select class="form-select" id="kategori" name="kategori" value="<?= $result['kategori'] ?>">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['upload1'])) {
                                ...
                                $getfoto = move_uploaded_file($file, $directory.$foto);
                                $date = date('Y-m-d');
                                $connection->query("UPDATE tb_produk SET foto_utama = '$foto' WHERE id_pengguna = '$_SESSION[id]' AND created_at LIKE '%$date%' AND foto_utama IS NULL");
                            }
                            ?>
                            <form action="" class="dropzone" method="POST" enctype="multipart/form-data">
                                <div class="fallback">
                        ...
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['upload2'])) {
                                ...
                                $getfoto = move_uploaded_file($file, $directory.$foto);
                                $date = date('Y-m-d');
                                $connection->query("UPDATE tb_produk SET foto_dua = '$foto' WHERE id_pengguna = '$_SESSION[id]' AND created_at LIKE '%$date%' AND foto_dua IS NULL");
                            }
                            ?>
                            <form action="" class="dropzone" method="POST" enctype="multipart/form-data">
                                <div class="fallback">
                        ...
                        <div class="col-lg-4">
                            ...
                            if (isset($_POST['upload3'])) {
                                ...
                                $getfoto = move_uploaded_file($file, $directory.$foto);
                                $date = date('Y-m-d');
                                $connection->query("UPDATE tb_produk SET foto_tiga = '$foto' WHERE id_pengguna = '$_SESSION[id]' AND created_at LIKE '%$date%' AND foto_tiga IS NULL");
                            }
                            ?>
                            <form action="#" class="dropzone" method="POST" enctype="multipart/form-data">
                                <div class="fallback">
